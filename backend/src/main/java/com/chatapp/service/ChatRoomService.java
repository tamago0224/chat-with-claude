...
public class ChatRoomService {
    ...
    public Page<ChatRoom> searchPublicRooms(String searchTerm, Pageable pageable) {
        return chatRoomRepository.findPublicRoomsByNameOrDescriptionContainingIgnoreCase(searchTerm, pageable);
    }

    public List<ChatRoom> searchUserRooms(String userId, String searchTerm) {
        return chatRoomRepository.findUserRoomsByNameOrDescriptionContainingIgnoreCase(userId, searchTerm);
    }
