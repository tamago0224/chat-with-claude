...
class ApiSpecificationComplianceTest {
    ...
    void setUp() {
        ...
        validToken = jwtUtil.generateToken(testUser.getId(), testUser.getEmail(), testUser.getName(), testUser.getPicture());
    }
    ...
    void testMessageAccessControlCompliance() throws Exception {
        ...
        mockMvc.perform(get("/api/messages/room/" + room.getId())
                .header("Authorization", "Bearer " + validToken))
